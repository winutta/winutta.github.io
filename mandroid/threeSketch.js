...
function main(){
	...
	function onWindowResize(){
	    ...
	    console.log("videoDim",videoElement.videoWidth, videoElement.videoHeight);
	    console.log("dim",  videoElement.width, videoElement.height);
	    console.log("canvasDim", canvas.width, canvas.height);
	    console.log("inneDim", window.innerWidth,window.innerHeight);
